  ...
  data() {
    ...
    createPermission: function () {
      ...
      formData.append("country_id", this.form.country_id);
        ...
        var url = "/editorial/" + this.form.id;
        axios
            .post(url, formData)
        .then((response) => {
          this.errors = [];
          this.getClearFormObject();
          toastr.success("Editorial Modificada");
    ...
    UpdateGetRol(role) {
      ...
      this.form.address = role.attributes.address|| "";
      this.form.phone = role.attributes.phone|| "";
      this.form.email = role.attributes.email|| "";
